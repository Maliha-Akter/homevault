...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 h-screen bg-slate-900 text-slate-200 flex flex-col justify-between border-r border-slate-800 sticky top-0 z-40">
            {/* Top Brand Section */}
            <div>
                <div className="h-16 flex items-center px-6 border-b border-slate-800">
                    <Link href="/" className="text-lg font-black tracking-wider flex items-center gap-2 group">
