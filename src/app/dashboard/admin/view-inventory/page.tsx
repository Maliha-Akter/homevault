                ...
                <table className="min-w-full table-auto border-collapse text-left text-sm">
                    <thead>
                        <tr className="border-b border-slate-100">
                            ...
                            <th className="bg-slate-50/50 text-slate-600 font-bold px-4 py-3">CATEGORY</th>
                            ...
                            <tr>
                                <td colSpan={5} className="text-center py-12 text-slate-400 font-medium">
                                    <div className="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <span>No inventory added yet. Click refresh or register items to get started.</span>
                                    </div>
                                </td>
                            </tr>
                        ) : (
                                ...
                                <tr key={item._id} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/40 transition-colors">
                                    ...
                                    <td className="px-4 py-3.5">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-bold text-slate-900 text-sm">{item.title || "Untitled Asset"}</div>
                                    ...
                                    {/* Quality Matrix */}
                                    <td className="px-4 py-3.5">
                                        <span className="text-xs font-bold text-slate-600 px-2.5 py-1 bg-slate-100 rounded-lg inline-block">{item.condition || "N/A"}</span>
                                    </td>
                                    {/* Management Actions */}
                                    <td className="px-4 py-3.5">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-fade-in">
                    <form onSubmit={handleUpdateAsset} className="relative w-full max-w-2xl bg-white rounded-2xl shadow-xl flex flex-col max-h-[90vh] overflow-hidden">
                        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <button type="button" onClick={() => setIsEditOpen(false)} className="text-slate-400 hover:text-slate-600 text-sm font-semibold">Close</button>
                        </div>

                        <div className="px-6 py-4 overflow-y-auto space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">

                                {/* --- NON-EDITABLE CATEGORY FIELDS --- */}
                                ...
                                <div className="flex flex-col gap-1 md:col-span-2">
                                    ...
                                    <input required type="url" name="image" value={editForm.image} onChange={handleEditInputChange} className="w-full h-10 bg-slate-50 border border-slate-200 rounded-xl px-3 text-sm outline-none focus:border-orange-500 focus:bg-white transition-colors" />
                                </div>
                                <div className="flex flex-col gap-1">
